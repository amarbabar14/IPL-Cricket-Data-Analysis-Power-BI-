...
Top Run Scorers (Orange Cap analysis)

Top Wicket Takers (Purple Cap analysis)
...
Line Charts (Season Trends)

Pie/Donut Charts

Slicers for Team, Season, Venue, and Player filtering

Drill-through and Cross-filtering features

• Analyzed team performance, player consistency, toss impact, match results, and venue advantages to generate actionable cricket insights for strategic decision-making.

• Optimized dashboard performance using proper data modeling techniques such as star schema design, relationship management, and measure-based calculations.
